...
"""
Output files generated by this script (saved in outputs/comparison/):  
...
PREP_DIR = PROJECT_ROOT / "outputs" / "preprocessed"
...
try:
    ...
    plt.tight_layout()
    plt.savefig(
        OUTPUT_DIR / "feature_importance_dt_rf_xgb_core.png",
        dpi=300,
        bbox_inches="tight",
    )
    ...
    print("   Run src/experimental/dt_exploratory.py first.")
...
print(
    "   5. feature_importance_dt_rf_xgb_core   → Cross-method feature agreement (DT/RF/XGB)"
)
