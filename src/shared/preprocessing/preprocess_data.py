...
print("=" * 80)
print(f"Features: 16 core + {CIR_END - CIR_START} CIR samples + engineered features")
print(
...
engineered_matrix, engineered_names = engineer_features(
    X, feature_columns, cir_start=CIR_START, cir_end=CIR_END
)
